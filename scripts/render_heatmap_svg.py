...
53-week × 7-day rounded green boxes that reveal once with a diagonal
line-after-line slide-down (CSS keyframes — play on load, then freeze).
"""
import datetime
import json
import os
...
""".strip()
    ...
    parts.append(
        ...
        f'text-anchor="middle">swapnaj@github: ~/contributions --graph</text>'
    )
